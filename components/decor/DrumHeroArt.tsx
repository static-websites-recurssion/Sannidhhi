    ...
    >
      <defs>
        ...
        <linearGradient id="drum-band" x1="0" y1="0" x2="1" y2="0">
          ...
          <stop offset="50%" stopColor="#14365c" />
          <stop offset="100%" stopColor="#0a1628" />
        </linearGradient>
        <linearGradient id="drum-red" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#c41e3a" />
          <stop offset="100%" stopColor="#7f1225" />
        </linearGradient>
      ...
      <ellipse cx="360" cy="400" rx="280" ry="28" fill="#0a1628" opacity="0.12" />
      <g filter="url(#soft)">
        <g transform="translate(80 60)">
          ...
          <path
            ...
            strokeWidth="1"
          />
          <ellipse cx="140" cy="312" rx="78" ry="22" fill="#aabbd0" />
        ...
        <g transform="translate(300 30)">
          ...
          <path
            ...
            strokeWidth="1"
          />
          <ellipse cx="140" cy="332" rx="78" ry="22" fill="#aabbd0" />
          <rect x="85" y="130" width="110" height="48" rx="4" fill="url(#drum-red)" opacity="0.88" />
          <rect x="100" y="220" width="80" height="10" rx="2" fill="#0a1628" opacity="0.35" />
        </g>
        <g transform="translate(500 80)">
          ...
          <path
            ...
            strokeWidth="1"
          />
          <ellipse cx="100" cy="242" rx="58" ry="16" fill="#aabbd0" />
