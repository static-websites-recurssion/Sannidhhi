...
export function AboutSummarySection() {
  return (
    <section className="border-b border-navy-900/8 bg-white py-16 lg:py-24">
      <Container>
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <Reveal delay={0.08}>
            <div className="rounded-3xl border border-navy-900/10 bg-gradient-to-br from-surface to-white p-8 shadow-sm shadow-navy-900/5">
              <ul className="space-y-4 text-sm leading-relaxed text-navy-800/85">
                ...
                <li className="flex gap-3">
                  <span className="mt-1 h-2 w-2 shrink-0 rounded-full bg-navy-800/40" />
